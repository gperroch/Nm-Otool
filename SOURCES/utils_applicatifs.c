...
t_symbol_display			*find_symtab(struct mach_header_64 *header, char to_display)
{
	...
	{
//		printf("name:[%-40s] n_type:[%8s] n_sect:[%8d] n_desc:[%8s] n_value:[%8llu]\n", &((char*)strtab)[(nlist->n_un).n_strx], ft_itoabase(nlist->n_type, 2), nlist->n_sect, ft_itoabase(nlist->n_desc, 2), nlist->n_value);
